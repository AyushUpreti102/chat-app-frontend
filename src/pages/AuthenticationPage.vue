    ...
    <q-card class="q-pa-md" style="width: 400px">
      ...
      <q-form @submit="handleSubmit">
        <q-card-section>
          ...
          <q-input v-if="!isLogin" v-model="username" label="Username" filled class="q-mb-md" required />

          <q-input v-model="email" :label="!isLogin ? 'Email' : 'Username or email'" :type="!isLogin ? 'email' : 'text'"
            filled class="q-mb-md" required />
          <q-input v-model="password" label="Password" type="password" filled required />
        </q-card-section>

        <q-card-actions class="block">
          <q-btn class="full-width" type="submit" :label="isLogin ? 'Login' : 'Signup'" color="primary" />
        </q-card-actions>
      </q-form>
      ...
      <q-card-section class="text-center">
        <q-btn flat color="secondary" @click="isLogin = !isLogin" :label="isLogin
